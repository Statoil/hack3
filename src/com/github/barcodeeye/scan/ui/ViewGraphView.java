 ...
 */
public final class ViewGraphView extends View {
    ...
    public ViewGraphView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static final class ViewfinderResultPointCallback implements
        ...
        private final ViewGraphView viewfinderView;

        public ViewfinderResultPointCallback(ViewGraphView viewfinderView) {
