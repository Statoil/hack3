 ...
 */
public final class GraphActivityHandler extends Handler {

    private static final String TAG = GraphActivityHandler.class
            .getSimpleName();
    ...
    GraphActivityHandler(GraphActivity activity,
